...
<head>
    ...
    <!-- Title -->
    <title>BV - Modern Music HTML5 Template</title>
    ...
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
            ...
            <div class="single-hero-slide d-flex align-items-center justify-content-center">
                <!-- Slide Img -->
                <div class="slide-img bg-img" style="background-image: url(img/bg-img/bg1.jpg);"></div>
                <!-- Slide Content -->
                <div class="container">
                ...
                <div class="col-12 col-sm-4 col-md-3 col-lg-2 single-album-item t c p">
                    <div class="single-album">
                        <div class="album-info">
                            <a href="likedsongs.jsp">
                             <img src="img/bg-img/likedsonglogo.jpg" alt="">
                                <h3 style="color: white;">Liked Songs</h3>
                            </a>
                ...
                <!-- Single Album -->
                <div class="col-10 col-sm-4 col-md-4 col-lg-3 single-album-item s e q">
                    <div class="single-album">
                        <div class="album-info">
                            <a href="hot_track.jsp">
                             <img src="img/bg-img/a2.jpg" alt="">
                                <h3 style="color: white;">Hot Tracks</h3>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <!-- Single Album -->
                <div class="col-10 col-sm-4 col-md-3 col-lg-2 single-album-item t c p">
                    <div class="single-album">
                        <div class="album-info">
                            <a href="playlist.jsp">
                           <img src="img/bg-img/a3.jpg" alt="">
                                <h3 style="color: white;">Your PlayList</h3>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-10 col-sm-4 col-md-3 col-lg-2 single-album-item t c p">
                    <div class="single-album">
                        <div class="album-info">
                            <a href="on_repeat.jsp">
                           <img src="img/bg-img/repeat.png" alt="">
                                <h3 style="color: white;">Repeat</h3>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="single-hero-slide d-flex align-items-center justify-content-center">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-slides-content text-center">
                                <h6 data-animation="fadeInUp" data-delay="500ms"><div class="container">
                    <div class="row oneMusic-albums">
                ...
                <div class="col-12 col-sm-4 col-md-3 col-lg-3 single-album-item t c p">
                    <div class="single-album">
                        <div class="album-info">
                            <a href="evergreen.jsp">
                             <img src="img/bg-img/evergreen.jpg" alt="">
                                <h5 style="color: white;">Evergreen songs</h5>
                            </a>
                ...
                <div class="col-10 col-sm-4 col-md-4 col-lg-3 single-album-item s e q">
                    <div class="single-album">
                        <div class="album-info">
                            <a href="melody.jsp">
                             <img src="img/bg-img/melody.jpg" alt="">
                                <h3 style="color: white;">Melody hits</h3>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <!-- Single Album -->
                <div class="col-10 col-sm-4 col-md-3 col-lg-3 single-album-item t c p">
                    <div class="single-album">
                        <div class="album-info">
                            <a href="mass_stuff.jsp">
                           <img src="img/bg-img/mass.jpg" alt="">
                                <h5 style="color: white;">Telugu Mass Stuff</h5>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="albums-slideshow owl-carousel">
                        ...
                        <div class="single-album">
                            <div class="album-info">
                                <a href="kushi.jsp">
                                  <img src="img/bg-img/a1.jpeg" alt="">
                                    <h5>Kushi</h5>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="single-album">
                            <div class="album-info">
                                <a href="mirapakay.jsp">
                            <img src="img/bg-img/mirapakay.jpg" alt="">
                                    <h5>Mirapakay</h5>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="single-album">
                            <div class="album-info">
                                <a href="jalsa.jsp">
                            <img src="img/bg-img/jalsa.jpg" alt="">
                                    <h5>Jalsa</h5>
                                </a>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-2">
                    <div class="single-album-area wow fadeInUp" data-wow-delay="200ms">
                        ...
                        <div class="album-info">
                            <a href="pushpa.jsp">
                            <img src="img/bg-img/pushpa.jpg" alt="">
                                <h5>Pushpa</h5>
                            </a>
                            <p>Buble Gum</p>
                        </div>
